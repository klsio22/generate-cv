                  ...
                  <div className="flex gap-3 mt-2 pt-1">
                    {data.linkedin && (
                      <a href={`https://${data.linkedin}`} target="_blank" rel="noopener noreferrer" 
                        ...
                        <span className="text-xs">{data.linkedinName?.trim() ? data.linkedinName : data.linkedin.replace(/^https?:\/\/(www\.)?/, '').replace(/\/$/, '')}</span>
                      </a>
                    )}
                    {data.github && (
                      <a href={`https://${data.github}`} target="_blank" rel="noopener noreferrer"
                         ...
                         title="GitHub">
                        <span className="text-lg">💻</span>
                        <span className="text-xs">{data.githubName?.trim() ? data.githubName : data.github.replace(/^https?:\/\/(www\.)?/, '').replace(/\/$/, '')}</span>
                      </a>
                    )}
                    {data.portfolio && (
                      <a href={`https://${data.portfolio}`} target="_blank" rel="noopener noreferrer"
                         ...
                         title="Portfolio">
                        <span className="text-lg">🌐</span>
                        <span className="text-xs">{data.portfolioName?.trim() ? data.portfolioName : data.portfolio.replace(/^https?:\/\/(www\.)?/, '').replace(/\/$/, '')}</span>
                      </a>
                    )}
                  </div>
                )}
